...
public class AgedDebtAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public AgedDebtAdapter(Context context, ArrayList<CustomersModel> modelList) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_aged_debt, viewGroup, false);
