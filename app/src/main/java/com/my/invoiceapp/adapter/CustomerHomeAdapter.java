...
public class CustomerHomeAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public CustomerHomeAdapter(Context context, ArrayList<CustomersModel> modelList) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_customers_home, viewGroup, false);
